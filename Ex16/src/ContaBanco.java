...
//                Utilizamos o setSaldo para enviarmos o novo valor de saldo, pegamos o valor de saldo utilizando o getSaldo e tiramos dele o valor que a pessoa vai sacar
                this.setSaldo(this.getSaldo() - valor);
